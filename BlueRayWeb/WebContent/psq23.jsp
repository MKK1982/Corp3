		...
		if (request.getParameter("type") == null) {
			...
			else if (no == 126) 
			{
				...
				try {
					...
					String QueryString = "Select Branch_Name,count(*) as Count,to_char(Round(sum(Gross_Weight),3),'9999999999.999') as Gross_Weight,sum(-1*Closing_Balance) as Os from JL_Master_View a left join Branch_Master b on a.Branch_Code=b.Branch_Code group by a.Branch_Code,Branch_Name order by a.Branch_Code";
					//out.println(QueryString);
					...
					statement2 = conn1.createStatement();
					String QueryString2 ="Select 'Total' as Branch_Name,count(*) as Count,to_char(Round(sum(Gross_Weight),3),'9999999999.999') as Gross_Weight,sum(-1*Closing_Balance) as Os from JL_Master_View";
				...
				response.addHeader("AustinAndroidReturn", output);
 				 ...
 				 String redirectURL2 = "https://corporate.snnl.net/Daily_Collection";
				//  String redirectURL = "http://117.200.75.23/Daily_Collection";
...
try {
	...
	final URLConnection urlCon = new URL(redirectURL2).openConnection();
...
try {
//out.println("Enter in to url");
    URL url = new URL(redirectURL2);
HttpsURLConnection uc = (HttpsURLConnection)url.openConnection();
out.println(uc.getResponseCode());

String output = uc.getResponseMessage();
out.println(output);



out.println(uc.getHeaderField("VectorFExp").toString());
