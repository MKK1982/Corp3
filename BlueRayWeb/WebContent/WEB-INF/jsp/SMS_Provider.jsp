...
<body >
	<div id="page-wrap">
					...
					<table width="100%" style="height: 550px;width:1100px;" cellpadding="0"
						...
						<td id="leftbar">
							...
							<td class="All_Round" style="vertical-align: top">
							  ...
							  <!-- -------------------------------------------------------- ------------------------------>
                           <!-- ---------------------------------------------------------------------------------------- -->
                                							<form:form method="post" action="${pageContext.servletContext.contextPath}/saveSMS_Provider" modelAttribute="SMS_Provider">
     ...
     <table class="tbl_Content">
										...
										<tr>
											<th colspan="4" style="padding-left: 10px">SMS Provider <br />
												<hr />
											</th>
										</tr>
										<tr>
											<td>Provider Name - Status</td>
											  <td>
                          ...
                          <form:select path="Branch_Type" id="ddl_Scheme" class="ddList" Style="width:180px">
                                ...
                                </td>											<td><input type="submit" value="Update" class="btn_Blue" id="Save_Button">
											
										</tr>
										<tr><td><font color="Blue">${message}</font></td>
										</tr>
										<tr style="display:none;">
										<td >Category Description</td>
											<td style="display:none;"><form:input path="Status" /></td>
											</td>
										...
										<table style="display:none;" border="2" width="70%" cellpadding="2" class="mGrid">
											<tr>
												<th><font size="2px">Category Name</font></th>
												<th style="display:none;"><font size="2px">Category Description</font></th>
  					 ...
  					 -->
													<td><font size="2px"><c:out value="${jd.s2}" /></font></td>
													<td style="display:none;"> <font size="2px"><c:out value="${jd.s31}" /></font></td>


													<td Style="${DeleteLinkDisplay}"><font size="2px"><a href="<%=request.getContextPath()%>/deleteCategory_Master/${jd.s2}">Delete</a></font></td>
												</tr>
											</c:forEach>
										</table>
										<br />
