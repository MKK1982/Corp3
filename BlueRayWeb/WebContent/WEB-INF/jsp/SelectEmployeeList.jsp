...
function OpenPopup2(empid)
{

	//alert('hi '+empid);
	window.opener.document.getElementById('txt_Emp_Id').value=empid;
	window.close();
}
...
<script type="text/javascript" language="javascript">
        ...
        function OpenPopup3(empid)
        {

        	window.opener.location.href='<%=request.getContextPath()%>/selectEmpDetails/'+empid;
        	window.close();
        }
        
        
        function OpenPopup21(empid)
        {
...
<body>
	...
	<!-- 	<a href="<%=request.getContextPath()%>/Share_Master"
				onclick="getValue();"><img width="30" height="30" src="${pageContext.request.contextPath}/resources/images/Close.png"></a>-->
									...
									<table border="2" width="70%" cellpadding="2" class="mGrid">
										...
										<c:forEach var="jd" items="${list}">
											<tr>
												...
												<td><c:out value="${jd.s31}" /></td>

										  <td style="${jd22.s33}"><a onclick="OpenPopup2('${jd.s3}');" href="#">Select</a></td>	</tr>
										</c:forEach>
									</table>
