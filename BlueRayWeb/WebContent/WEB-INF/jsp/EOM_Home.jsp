	...
	<div id="page-wrap">
		...
		<table width="95%">
			...
			<tr>
				<td>
					...
					<table width="100%" style="height: 550px;width:1100px;" cellpadding="0"
						...
						<tr>
							<td id="leftbar">
							<%@include file="/WEB-INF/jsp/LeftBar_EOM.jsp" %>
							</td>
            ...
            <tr>
                ...
                <td>
                    <a href="<%=request.getContextPath()%>/Log_Home"><img src="resources/Images/Logs.jpeg" alt="Logs" width="130px" height="100px"/></a>
                </td>
                 <td>
                    <a href="<%=request.getContextPath()%>/Settings_Home"><img src="resources/Images/Settings.jpeg" alt="Settings" width="130px" height="100px"/></a>
                </td>
                
              <td>
                    <a href="<%=request.getContextPath()%>/EOM_Home"><img src="resources/Images/EOM.jpeg" alt="EOM" width="130px" height="100px"/></a>
                </td>
