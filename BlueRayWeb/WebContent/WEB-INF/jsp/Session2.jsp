									...
									<tr>
										<td align="left"><span
											style="font-size: 26px; font-weight: bold; color: #E42232;">
												Already login ! </span> <span
											style="font-size: 24px; font-weight: bold; color: #000071;">Try After Some time/Logout Other Sessions.
												 <br /> You must login again. <br /> <br />
										</span> <span
											style="font-size: 20px; font-weight: bold; color: #000071;">
												Logout ! : <a href="<%=request.getContextPath()%>/logout">Click here </a> 
										</span></td>
									</tr>
								</table>
							</td>
