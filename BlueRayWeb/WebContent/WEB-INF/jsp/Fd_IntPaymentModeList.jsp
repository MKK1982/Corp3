...
<title>FD Count - Payment Mode</title>
</head>
<body>
								...
								<table>
									...
									<table border="2" width="100%" cellpadding="2" class="mGrid">
										...
										<tr>
											...
											<th><font size="2px">Scheme </font></th>
											<th><font size="2px">Mode</font></th>
											<th><font size="2px">No of Accs</font></th>
											
										</tr>
										<c:forEach var="jd" items="${list}">
											<tr>
												<td><font size="2px" color="green"><c:out value="${jd.s33}" /></font></td>
												<td><font size="2px" color="green"><c:out value="${jd.s32}" /></font></td>
												<td><font size="2px" color="green"><c:out value="${jd.s3}" /></font></td>
