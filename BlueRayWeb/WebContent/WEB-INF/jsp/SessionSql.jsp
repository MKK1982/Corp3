									...
									<tr>
										<td align="left"><span
											style="font-size: 26px; font-weight: bold; color: #E42232;">
												DB Connection ! </span> <span
											style="font-size: 24px; font-weight: bold; color: #000071;">Accessing/Input Data Values Error. <br /> Kindly Check DB Network. <br /> <br />
										</span> <span
											style="font-size: 20px; font-weight: bold; color: #000071;">
												<a href="<%=request.getContextPath()%>/logout">Login</a>
												<a href="<%=request.getContextPath()%>/Welcome">DashBoard</a> to
																						</span></td>
									</tr>
								</table>
							</td>
