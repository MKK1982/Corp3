...
function OpenPopup(Accno,Name,user1)
{
	
	//alert(user1);
		window.opener.document.getElementById('txt_Target_Id').value=Accno;
		window.opener.document.getElementById('txt_Target_Name').value=Name;
		window.opener.document.getElementById('id_username').value=user1;
		var path="${pageContext.servletContext.contextPath}";
    	var snnl4 = "${pageContext.request.contextPath}";
    	//alert(snnl4);
    	var url=path+"/GetPermissionBranch/" + user1+"";
    	//alert(url);
        popupWindow = window.opener.open(url);
        window.close();
        window.opener.close();
						...
						<tr>
							...
							<td class="All_Round" style="vertical-align: top">
								...
								<table class="tbl_Content">
									...
									<table border="2" width="70%" class="mGrid">
										
										<tr>
										<th><font size="2px" >User Id</font></th>
										   <th><font size="2px" >Emp No</font></th>
											<th><font size="2px" ></font>Emp Name</font></th>
												<th><font size="2px" ></font>Select</font></th>
										</tr>
										<c:forEach var="jd" items="${list}">
											<tr>
											<td><font size="2px" color="black"><c:out value="${jd.s4}" /></font></td>
												<td><font size="2px" color="black"><c:out value="${jd.s2}" /></font></td>
												<td><font size="2px" color="black"><c:out value="${jd.s3}" /></font></td>
												

										<td><font size="2px" color="black"><a onclick="OpenPopup('${jd.s2}','${jd.s3}','${jd.s4}');" href="#">Select</a></font></td> 
											</tr>
										</c:forEach>
									</table>
									<br />
