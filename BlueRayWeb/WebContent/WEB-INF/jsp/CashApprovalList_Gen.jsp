						...
						<tr>
							...
							<td class="All_Round" style="vertical-align: top">
								...
								<table class="tbl_Content">
									...
									<tr>
										<th colspan="2">Cash Approval Details<br />
											<hr />
										</th>
									</tr>
									...
									<table border="2" width="70%" cellpadding="2" class="mGrid">
										...
										<tr>
											...
											<th><font size="2px">Cash Approval</font></th>
											<th><font size="2px">Transaction Dt</font></th>
											
										</tr>
										<c:forEach var="jd" items="${list}">
											<tr>
												<td><font size="2px" color="${jd.s35}"><c:out value="${jd.s2}" /></font></td>
												<td><font size="2px" color="${jd.s35}"><c:out value="${jd.s4}" /></font></td>
												<td><font size="2px" color="${jd.s35}"><c:out value="${jd.s3}" /></font></td>
																							<td><font size="2px" color="${jd.s35}"><c:out value="${jd.s5}" /></font></td>
