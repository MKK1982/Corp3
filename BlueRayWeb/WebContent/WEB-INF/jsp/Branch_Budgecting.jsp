			...
			<tr>
				<td>
					...
					<table width="100%" style="height: 550px;width:1100px;" cellpadding="0"
						...
						<tr>
							<td id="leftbar">
							<%@include file="/WEB-INF/jsp/LeftBar21.jsp" %>
							</td>

							<td>&nbsp;</td>
							
							<td class="All_Round" style="vertical-align: top;width:1200px;" >
							<div class="m1">Branch Budgeting</div>
