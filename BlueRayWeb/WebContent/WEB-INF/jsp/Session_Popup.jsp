									...
									<tr>
										<td align="left"><span
											style="font-size: 26px; font-weight: bold; color: #E42232;">
												Session Expired! </span> <span
											style="font-size: 24px; font-weight: bold; color: #000071;">Your
												Connection Expired. <br /> You must login again. <br /> <br />
										</span> <span
											style="font-size: 20px; font-weight: bold; color: #000071;">
												Close the Window !<!-- <a href="<%=request.getContextPath()%>/WelCome">Click here</a> to
												login.-->
										</span></td>
									</tr>
								</table>
