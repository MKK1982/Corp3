...
<script type="text/javascript" language="javascript">
        ...
        function OpenPopup2(Accno)
        {

        	window.opener.document.getElementById('txt_Customer_Id').value=Accno;
    		window.close();
        }
...
<body>
	<div id="page-wrap">
		...
		<tr>
			<th><font size="2px">Employee List <br />
				<hr />
				</font>
			</th>
		</tr>
		<tr>
			...
			<th><font size="2px">Select</font></th>
		...
		<c:forEach var="jd" items="${list}">
			<tr>
				...
				<td><font size="2px"><c:out value="${jd.s3}" /></font></td>
				 <td ><font size="2px"><a onclick="OpenPopup2('${jd.s2}');" href="#">Select</a></font></td>
			</tr>
		</c:forEach>
	</table>
