...
<body>
  ...
  <div class="center">
    <div style="color:red;">
                     ...
                     <ul >
                         <li><h3>The session has expired due to one of the following reasons </h3></li>
                         <li><h3>Due to inactivity</li>
						 <li><h3>You have Pressed F5 or refresh button</h3></li>
						 <li> <h3> You have pressed back button. </h3></li>
                     </ul>
                      <span
											style="font-size: 20px; font-weight: bold; color: #000071;">
												<a href="<%=request.getContextPath()%>/">Click here</a> to
												login.
										</span>
                </div>
  </div>
