			...
			<tr>
				<td>
					...
					<table width="100%" style="height: 550px;width:1100px;" cellpadding="0"
						...
						<tr>
							<td id="leftbar">
							<%@include file="/WEB-INF/jsp/LeftBar5.jsp" %>
							</td>
						...
						<td>&nbsp;</td>
							...
							<!-- --------------------------------------------------------- -->
							<form:form 	method="post" action="${pageContext.servletContext.contextPath}/editsavePassword" modelAttribute="Change_Password" commandName="Change_Password">
									...
									<table class="tbl_Content">
										...
										<tr>
											<th colspan="8">Change Password <br />
												<hr />
											</th>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><form:password path="Re_Password" /></td>
										</tr>

										<tr>
											<td><input type="submit" value="Save" class="btn_Blue" style="${SaveFlag}" name="Save">

											</td>
											<td><input type="submit" value="Reset" class="btn_Blue" style="${UpdateFlag}" name="Reset">
