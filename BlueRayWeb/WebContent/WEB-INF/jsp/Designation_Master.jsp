...
<body >
	<div id="page-wrap">
					...
					<table width="100%" style="height: 550px;width:1100px;" cellpadding="0"
						...
						<td id="leftbar">
							...
							<td class="All_Round" style="vertical-align: top">
							  ...
							  <!-- -------------------------------------------------------- ------------------------------>
                           <!-- ---------------------------------------------------------------------------------------- -->
                                							<form:form method="post" action="${pageContext.servletContext.contextPath}/saveDesignation_Master" modelAttribute="Employee3">
     ...
     <table class="tbl_Content">
										...
										<tr>
											<th colspan="4" style="padding-left: 10px">Designation
												Master <br />
												<hr />
											</th>
										</tr>
										<tr>
											...
											<td><form:input path="Bank_Desc" /></td>
  					 ...
  					 -->
													...
													<td Style="${DeleteLinkDisplay}"><font size="2px"><a href="<%=request.getContextPath()%>/deleteDesignation_Master/${jd.s2}">Delete</a></font></td>
												</tr>
											</c:forEach>
										</table>
										<br />
