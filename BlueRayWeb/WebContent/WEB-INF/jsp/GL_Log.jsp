...
<%-- <link href="<c:url value="/resourses/CSS/jquery-ui.css" />" rel="stylesheet" /> --%>
				...
				<td>
					...
					<table width="100%" style="height: 550px;width:1100px;" cellpadding="0"
						...
						<tr>
							...
							<tr>
							<form:form method="post" action="${pageContext.servletContext.contextPath}/ViewGL_Log" modelAttribute="kk" commandName="kk" name="login">
								<td>
								...
								<form:select path="Branch_Type" id="ddl_Scheme" class="ddList" style="width:25%">
                                    ...
                                    <input type="submit" value="Report" name="GL_Log" class="btn_Blue"  id="Translog"/>
