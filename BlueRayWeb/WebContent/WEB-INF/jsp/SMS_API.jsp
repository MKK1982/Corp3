					...
					<table width="100%" style="height: 550px;width:1100px;" cellpadding="0"
						...
						<td>&nbsp;</td>
							...
							<td class="All_Round" style="vertical-align: top">
								...
								<form:form
										method="post"
										action="${pageContext.servletContext.contextPath}/saveSMS_API"
										modelAttribute="SMS_API" commandName="SMS_API">
										...
										<table class="tbl_Content">
											...
											<tr>
												<th colspan="2">SMS API Settings</th>
											</tr>
											...
											<tr>
												<td colspan="2">
													<hr
														style="border-style: dashed; color: green; width: 98%; height: 1px" />
												</td>

											</tr>
											<tr>
												<td>Choose API</td>
												<td><form:select path="Employee_Name"
														style="width:175px" id="ddl_API">
														<form:options items="${APIList}" />
													</form:select> 
													&nbsp;
													<input type="submit" value="Save" class="btn_Blue" name="Save">
												</td>
