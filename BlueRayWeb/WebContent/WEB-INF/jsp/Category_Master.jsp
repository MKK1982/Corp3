...
<body >
	<div id="page-wrap">
					...
					<table width="100%" style="height: 550px;width:1100px;" cellpadding="0"
						...
						<td id="leftbar">
							...
							<td class="All_Round" style="vertical-align: top">
							  ...
							  <!-- -------------------------------------------------------- ------------------------------>
                           <!-- ---------------------------------------------------------------------------------------- -->
                                							<form:form method="post" action="${pageContext.servletContext.contextPath}/saveCategory_Master" modelAttribute="Employee3">
     ...
     <table class="tbl_Content">
										...
										<tr>
											<th colspan="4" style="padding-left: 10px">Category Master <br />
												<hr />
											</th>
										</tr>
										<tr>
											<td>Category Name</td>
											<td><form:input path="Bank_Desc" style="text-transform:uppercase"/></td>
																						<td><input type="submit" value="Add" class="btn_Blue" id="Save_Button">
