        ...
        */
        ...
        String[] ds = IndRecord.split("-");
        	...
        	// scheme ="3";
        	 ...
        	 if(int_rate!=null)
        	 {
        	 f=Float.parseFloat(int_rate)/100;
        	 }
        	 //------------------------------------------------
