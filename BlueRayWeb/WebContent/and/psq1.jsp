		...
		if (request.getParameter("type") == null) {
			...
			else if (no == 126) 
			{
				...
				try {
					...
					String QueryString = "Select Branch_Name,count(*) as Count,Round(sum(Gross_Weight),2) as Gross_Weight,sum(-1*Closing_Balance) as Os from JL_Master_View a left join Branch_Master b on a.Branch_Code=b.Branch_Code group by a.Branch_Code,Branch_Name order by a.Branch_Code";
					//out.println(QueryString);
					...
					statement2 = conn1.createStatement();
					String QueryString2 ="Select 'Total' as Branch_Name,count(*) as Count,Round(sum(Gross_Weight),2) as Gross_Weight,sum(-1*Closing_Balance) as Os from JL_Master_View";
