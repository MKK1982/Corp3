...
else if(b.equalsIgnoreCase("17"))
	{
		Bcode="218";
	}
else if(b.equalsIgnoreCase("18"))
	{
		Bcode="219";
	}
...
else if(b.equalsIgnoreCase("29"))
{
	Bcode="230";
}
else if(b.equalsIgnoreCase("30"))
{
	Bcode="231";
}
...
else if(b.equalsIgnoreCase("33"))
{
	Bcode="234";
}
else if(b.equalsIgnoreCase("34"))
{
	Bcode="235";
}
	 ...
	 String comp = request.getParameter("comp");//Request.QueryString["Tm"].ToString();
		...
		*/
        ...
        try
        {
            ...
            Class.forName("oracle.jdbc.driver.OracleDriver");
           conn1 = DriverManager.getConnection("jdbc:oracle:thin:@103.48.180.117:4547:xe", "dbuser1", "dbpwd1");
            out.println("connected....!!");
            statement = conn1.createStatement();
    	...
    	out.println("resp="+resp);
        	...
        	String temp_did_first=ds[0].substring(0,5);
        	String temp_did_last=ds[0].substring(5);
        	int intlast=Integer.parseInt(temp_did_last);
        	String nwdid=temp_did_first+intlast;
  	
            //old String dgid= ds[0];
                        String dgid= nwdid;
   ...
   /*  try
     ...
     try
     {
       ...
       //  out.println("Pword!"+Pword);
        ...
        // String query = "SELECT * FROM Dg_Customer";
        String query = "SELECT  * FROM    ( SELECT  q.*, rownum rn FROM    ( SELECT  distinct customer_id,customer_name,mobile_no FROM     Customer_view   ) q  ) WHERE   rn BETWEEN "+from+" AND "+to+" and customer_name is not null";
 rs2 = statement2.executeQuery(query);
