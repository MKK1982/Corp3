...
<BODY>
	...
	<%
		if (request.getParameter("type") == null) {
			...
			if (no == 1) {
				...
				Date s1=sd.parse(CDate);
				String Dt =sd2.format(s1);
				
			  
			        String urlInfo=devId+"&"+Dt;
 					 String redirectURL2 = "https://corporate.snnl.net/Daily_Collection127/"+urlInfo;
	 		//out.println(redirectURL2);		
	//---------------------------------------------------------------------------------------
	...
	// out.println("AfterucResponse");		


	//out.println(uc.getHeaderField("VectorFExp").toString());
	               
	 output=uc.getHeaderField("VectorFExp").toString();
	//response.addHeader("VectorFExp", output);
				...
				//out.println("Date is= <b>" + Dt + "</b>");
				  String urlInfo=devId+"&"+CDate;
	 				 String redirectURL2 = "https://corporate.snnl.net/Daily_Collection123/"+urlInfo;
	...
	//response.addHeader("VectorFExp", output);
			...
			else if (no == 126) 
			{
				...
				//String Dt = CDate;//CDate.substring(4,2);
				//out.println("Date is= <b>" + Dt + "</b>");
				  String urlInfo=devId;
	 				 String redirectURL2 = "https://corporate.snnl.net/Daily_Collection126/"+urlInfo;
	 		//out.println(redirectURL2);		
	//---------------------------------------------------------------------------------------
	// Create a trust manager that does not validate certificate chains
	TrustManager[] trustAllCerts = new TrustManager[]{
	...
	//response.addHeader("VectorFExp", output);
				...
				String output = "";
				  ...
				  String CDate = request.getParameter("Dt");
			        ...
			        String urlInfo=devId+"&"+mon+"&"+Dt;
 					 String redirectURL2 = "https://corporate.snnl.net/Daily_Collection129/"+urlInfo;
	 		//out.println(redirectURL2);		
	//---------------------------------------------------------------------------------------
	// Create a trust manager that does not validate certificate chains
	TrustManager[] trustAllCerts = new TrustManager[]{
	...
	//response.addHeader("VectorFExp", output);
				...
				response.addHeader("AustinAndroidReturn", output);
			        ...
			        String urlInfo=devId+"&"+uid+"&"+pwd+"&"+ss;
 				 String redirectURL2 = "https://corporate.snnl.net/Daily_Collection52/"+urlInfo;
...
String output=uc.getHeaderField("VectorFExp").toString();
...
//----------------------------------------------------------------------------------------				
 				 ...
 				 String redirectURL2 = "https://corporate.snnl.net/Check_DWT/"+ss;
...
//out.println(ss);
        ...
        String redirectURL2 = "https://corporate.snnl.net/Check_DWT2/"+ss;
