...
<%
    ...
    try
    {
        ...
        conn = DriverManager.getConnection("jdbc:oracle:thin:@103.48.180.117:4547:xe", "dbuser6", "dbpwd62017");
...
int no = Integer.parseInt(request.getParameter("type"));
   if(no == 1){
       ...
       try
       {
           ...
           Class.forName("oracle.jdbc.driver.OracleDriver");
           conn1 = DriverManager.getConnection("jdbc:oracle:thin:@103.48.180.117:4547:xe", "dbuser6", "dbpwd62017");
           out.println("connected....!!");
       ...
       try
       {
           ...
           Class.forName("oracle.jdbc.driver.OracleDriver");
           conn2 = DriverManager.getConnection("jdbc:oracle:thin:@103.48.180.117:4547:xe", Uname, Pword);
