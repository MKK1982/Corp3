	...
	<%
		if (request.getParameter("type") == null) {
			...
			else if (no == 126) 
			{
				...
				//String countqry = "select a.*,SUBSTR(a.col_two, 1, INSTR(a.col_two, '.')-1) AS time1,SUBSTR(a.col_two, INSTR(a.col_two, ' ')+1) AS ampm from (SELECT SUBSTR(daily_cb.Created_date, 1, INSTR(daily_cb.Created_date, ' ')-1) AS col_one, SUBSTR(daily_cb.Created_date, INSTR(daily_cb.Created_date, ' ')+1) AS col_two FROM daily_cb where CB_Date='"+Dt+"' and branch_code='201')a";
